...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, ClientRegistrationRepository clientRegistrationRepository) throws Exception {
        http
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/secure/**").authenticated() // Protege a rota "/secure"
            ...
            .logout(logout -> logout
                .logoutSuccessHandler(oidcLogoutHandler(clientRegistrationRepository)) // Garante logout correto no Keycloak
    ...
    public OidcClientInitiatedLogoutSuccessHandler oidcLogoutHandler(ClientRegistrationRepository clientRegistrationRepository) {
        ...
        logoutSuccessHandler.setPostLogoutRedirectUri("http://localhost:8081/"); // Define para onde o usuário será redirecionado após o logout
